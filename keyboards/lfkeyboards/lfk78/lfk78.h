...
void click(uint16_t freq, uint16_t duration);
    ...
    */
    ...
    /* RevC/D Keymap with split backspace and split right shift */
    // This a shortcut to help you visually see your layout.
    /*
    * ,---------.  ,-----------------------------------------------------------------------.  ,---------.
    * | 11 | 12 |  | 13 | 14 | 15 | 16 | 17 | 18 | 19 | 1A | 1B | 1C | 1D | 1E | 1F |1G|3G |  | 1H | 1I |
    * |---------|  |-----------------------------------------------------------------------|  |---------|
    * | 21 | 22 |  | 23  | 24 | 25 | 26 | 27 | 28 | 29 | 2A | 2B | 2C | 2D | 2E | 2F |  2G |  | 2H | 2I |
    * |---------|  |-----------------------------------------------------------------------|  `---------'
    * | 31 | 32 |  | 33    | 34 | 35 | 36 | 37 | 38 | 39 | 3A | 3B | 3C | 3D | 3E |     3F |
    * |---------|  |-----------------------------------------------------------------------|  ,----.
    * | 41 | 42 |  | 43      | 45 | 46 | 47 | 48 | 49 | 4A | 4B | 4C | 4D | 4E |  4F  | 4G |  | 4H |
    * |---------|  |-------------------------------------------------------------------------------------.
    * | 51 | 52 |  | 53  | 54  | 55 |               59                |  5D |  5E |  5F | | 5G | 5H | 5I |
    * `---------'  `--------------------------------------------------------------------' `--------------'
    */
    ...
    // The second converts the arguments into a two-dimensional array
    #define SPLIT_BS_SPLIT_SHIFT_KEYMAP( \
    ...
    /* RevC/D Keymap with split backspace */
    // This a shortcut to help you visually see your layout.
    /*
    * ,---------.  ,-----------------------------------------------------------------------.  ,---------.
    * | 11 | 12 |  | 13 | 14 | 15 | 16 | 17 | 18 | 19 | 1A | 1B | 1C | 1D | 1E | 1F |1G|3G |  | 1H | 1I |
